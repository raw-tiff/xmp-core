...
public class XMPNormalizer
{
	 ...
	 * @throws XMPException Forwards XMP errors
	 */
	private static void transplantArrayItemAlias(Iterator<XMPNode> propertyIt, XMPNode childNode,
			...
			boolean outerCall) throws XMPException 
	{
		...
		for (Iterator<XMPNode> an = aliasNode.iterateChildren(), 
		...
		for (Iterator<XMPNode> an = aliasNode.iterateQualifier(), 
